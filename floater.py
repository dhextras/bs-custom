...
try: from babase._generated.enums import InputType
except: from babase._enums import InputType
if TYPE_CHECKING:
    ...
    def __init__(self, bounds):
        ...
        self.node = bs.newnode(
            ...
            attrs={
                ...
                0.0,
                'color_texture':
                bui.gettexture('achievementFlawlessVictory'),
                'reflection':
                'soft',
...
def assignFloInputs(clientID: int):
    with babase.Context(_babase.get_foreground_host_activity()):
        ...
        if floater.controlled:
            bui.screenmessage('Floater is already being controlled', color=(1, 0, 0), transient=True, clients=[clientID])
            return
        bui.screenmessage('You Gained Control Over The Floater!\n Press Bomb to Throw Bombs and Punch to leave!', clients=[clientID], transient=True, color=(0, 1, 1))
...
_babase.chatmessage = new_chat_message
